...
// gcloud iot devices create test-device --project=iot-klutzer --region=us-central1 --registry=esp2886-test  --public-key path=ec_public.pem,type=es256

// WIFI
const char* ssid = "Lutzer";
const char* password = "3062623767";
