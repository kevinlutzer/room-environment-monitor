...
/**
 * @brief MQTTMsg is a class that is used to create a message that can be published to an MQTT broker.
 * The message is considered to be a immutable event, with it's own unique identifier.
 */
class MQTTMsg {
    public:
        ...
        /**
         * @brief a reference to the json document as a char string. Note that this data 
         * is just stored in the stack so it must be copied into heap memory for long term use
         */
